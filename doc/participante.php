...
<nav class="navbar navbar-inverse">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="escuela.html"><span class="glyphicon glyphicon-pencil"></span> Registrar Escuela</a></li>
            <li><a href="participante.php"><span class="glyphicon glyphicon-user"></span> Registrar Alumno</a></li>
          </ul>
        </div>
      </nav>
